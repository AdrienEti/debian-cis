...
#
# Ensure Mounting of overlayfs filesystems is disabled (Scored)
#
...
HARDENING_LEVEL=2
# shellcheck disable=2034
DESCRIPTION="Disable mounting of overlayfs filesystems."

KERNEL_OPTION="CONFIG_OVERLAY_FS"
MODULE_NAME="overlayfs"
